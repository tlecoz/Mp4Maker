...
const startRecordingButton = document.querySelector('#start-recording') as HTMLElement;
const endRecordingButton = document.querySelector('#end-recording') as HTMLElement;
const recordingStatus = document.querySelector('#recording-status') as HTMLElement;
